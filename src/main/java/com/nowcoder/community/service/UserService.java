...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user) {
        ...
        contex.setVariable("email", user.getEmail());
        //http://localhost:8080/community/activation/101/code
        String url = domain + contextPath + "/activation/" + user.getId() + "/" + user.getActivationCode();
        contex.setVariable("url", url);
        String content = templateEngine.process("/mail/activation", contex);
    ...
    public Map<String, Object> login(String username, String password, int expried) {
        Map<String, Object> map = new HashMap<>();
        //空值处理
        ...
        loginTicket.setExpired(new Date(System.currentTimeMillis() + expried * 1000));
